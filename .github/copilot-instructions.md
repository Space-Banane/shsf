...
SHSF (Self-Hostable Serverless Functions) is an open-source platform for deploying and managing serverless functions on your own infrastructure. It consists of a backend API server, a web-based UI dashboard.
