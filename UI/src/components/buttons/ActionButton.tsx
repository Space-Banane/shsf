export function ActionButton({
  ...
  const variantClasses = {
    primary: "bg-blue-600 text-white border border-blue-700 hover:bg-blue-700 hover:border-blue-800",
    secondary: "bg-background/50 border border-primary/20 text-primary hover:border-primary/40 hover:bg-primary/5",
    delete: "bg-red-600 text-white border border-red-700 hover:bg-red-700 hover:border-red-800"
  };
