      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-primary/20 rounded-2xl p-8 hover:border-primary/40 hover:shadow-[0_0_30px_rgba(124,131,253,0.1)] transition-all duration-300">
          <div className="text-center mb-8">
            ...
            <p className="text-text/60">Enter your credentials to access your account</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-primary/10">
            <h3 className="text-lg font-semibold text-text mb-4 text-center">Quick Access</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              >
                ...
                <p className="text-text/70 group-hover:text-text transition-colors duration-300">Documentation</p>
              </a>
              <a
                href="/"
                className="p-3 bg-background/30 rounded-lg hover:bg-background/50 transition-all duration-300 text-center group"
              >
                <div className="text-2xl mb-2 group-hover:scale-110 transition-transform duration-300">🏠</div>
                <p className="text-text/70 group-hover:text-text transition-colors duration-300">Back to Home</p>
              </a>
            </div>
          </div>
        </div>
