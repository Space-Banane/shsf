			...
			<div className="max-w-3xl mx-auto px-4 pb-16">
					...
					>
						...
						<div className="flex flex-col md:flex-row gap-4">
							<div className="flex-1">
								<label className="block text-text/60 text-sm mb-1">Token Name</label>
								<input
									type="text"
									required
									minLength={2}
						...
						<div className="flex flex-col gap-2 mt-2">
							...
							{shsfCliToken == null && (
								<>
									...
									/>
									{cliGenError && (
										<div className="text-red-400 text-sm mt-2">{cliGenError}</div>
									)}
								</>
							)}
						</div>
						{genError && <div className="text-red-400 text-sm mt-2">{genError}</div>}
				...
				<div>
					...
					{loading ? (
						...
						<>
							{revokeError && <div className="text-red-400 mb-2">{revokeError}</div>}
							{tokens.length === 0 ? (
