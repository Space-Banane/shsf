  ...
  return (
    <div className="min-h-screen bg-background text-text p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mt-3 text-lg text-text/90 mb-8">
          Learn how to create custom responses for your functions to handle
          different scenarios.
        </p>
        ...
        <p className="mb-4 text-text/90">
          To create a custom response, you can return a object with specific
          keys from your function. SHSF will need to see{" "}
          <code>"_shsf":"v2"</code> in the response, and then will process it
          accordingly.
        </p>
    ...
    if success_condition:
        ...
        <p className="mb-4 text-text/90">
          ...
          success condition. The <code>_code</code> key specifies the HTTP
          status code, and the <code>_res</code> key contains the actual
          response data.
        </p>
    ...
    if success_condition:
        ...
        <p className="mb-4 text-text/90">
          In this example, the function includes a custom header in the
          response.
        </p>
        ...
        <p className="mb-4 text-text/90">
          Custom responses in SHSF allow you to provide meaningful feedback from
          your functions. By including specific keys in your response, you can
          handle various scenarios effectively, including success and error
          cases.
        </p>
