    ...
    <div className="min-h-screen bg-background text-text p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mt-3 text-lg text-text/90 mb-8">
          Learn how to manage sensitive information like API keys using
          environment variables.
        </p>
        ...
        <p className="mb-4 text-text/90">
          ...
          secure by avoiding hardcoding sensitive data directly in your source
          code, which when screensharing or screenshotting can be a security
          risk.
        </p>
        <p className="mb-4 text-text/90">
          Even when pushing to public repositories, environment variables ensure
        ...
        <p className="mb-4 text-text/90">
          In SHSF, you can define environment variables for your functions
          through the dashboard. These variables will be accessible within your
          function code.
        </p>
        ...
        <p className="mb-4 text-text/90">
          Once you have set the environment variables, you can access them in
          your function code using the standard method for your programming
          language. For example, in Python, you can use the `os` module:
        </p>
...
def main(args):
    ...
    return {"_shsf": "v2", "_code": 200, "_res": {"api_key_used": bool(api_key)}}`}
        ...
        <ul className="list-disc list-inside mb-4 text-text/90">
          ...
          <li>
            Limit access to the SHSF dashboard to trusted team members only.
          </li>
        </ul>
