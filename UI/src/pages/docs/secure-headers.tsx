...
export const SecureHeadersPage = () => {
		...
		<div className="min-h-screen bg-background text-text p-8">
			<div className="max-w-4xl mx-auto">
				...
				<p className="mt-3 text-lg text-text/90 mb-6">
					...
					requests that are missing or invalid. SHSF will not reject a request when
					made from the functions owner, via the UI.
				</p>
  ...
  body: JSON.stringify({ foo: "bar" })
				...
				<p className="mb-3 text-text/90">
					...
					access the header value for logging or other purposes, here's how you can
					do it.
				</p>
    ...
    return {"_shsf": "v2", "_code": 200, "_res": {"state": True}}`}</code>
				...
				<ul className="list-disc pl-6 mb-6 text-text/90">
					<li>
						...
						<a href="/docs/environment-variables">environment variables</a> instead.
					</li>
					<li>
						The exact header forwarding object name can vary by runtime; if headers
						aren't available on args, consult the runtime docs for how to access raw
						request headers.
					</li>
					<li>
						The platform performs validation before invocation — functions can also
				...
				<div className="mt-12 p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-primary/30 rounded-xl">
					...
					<p className="text-text/90 mb-4">
						Know that we know how to keep our functions secure, let's take a look at
						how we can store and manage data for our functions.
					</p>
					<a
