    ...
    <div className="min-h-screen bg-background text-text p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-4 text-text/90">
          Click "Create Function" and fill out the required fields including
          name, description, and select the namespace you created.
        </p>
        <div className="mb-6 p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
          <p className="text-sm text-blue-300">
            <strong>Info:</strong> Most settings can be changed later via the
            UI. If something can't be modified, simply recreate the function -
            they're lightweight!
          </p>
        </div>
        ...
        <p className="mb-6 text-text/90">
          Navigate to your newly created function from the functions list.
          You'll see the function dashboard with various controls and tabs.
        </p>
        ...
        <p className="mb-4 text-text/90">
          ...
          startup file setting (you can change this later with the "Update
          Function" button).
        </p>
        ...
        <p className="mb-4 text-text/90">
          Open the file by clicking on it and add the following Discord webhook
          code:
        </p>
...
def main(args):
    ...
    return {"message": "Monday greeting sent!"}`}</code>
        ...
        <p className="mb-6 text-text/90">
          Click the save button at the top of the editor, near the run button,
        ...
        <p className="mb-4 text-text/90">
          Create a file named <code>requirements.txt</code> and set its content
          to:
        </p>
        <pre className="bg-gray-900 p-4 rounded-lg overflow-x-auto text-sm mb-6">
          <code>requests</code>
        ...
        <div className="mb-6 p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
          <p className="text-sm text-blue-300">
            <strong>Fun fact:</strong> Triggers can also be HTTP events! Enable
            "Allow HTTP" in function settings to create a webhook URL for your
            function.
          </p>
        </div>
        ...
        <p className="mb-4 text-text/90">
          Click "Create Trigger" and provide a name and description for your
          Monday greeting trigger.
        </p>
        ...
        <p className="mb-4 text-text/90">
          Set the cron expression to <code>0 0 * * 1</code> to run every Monday
          at midnight.
        </p>
        <div className="mb-6 p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
          <p className="text-sm text-blue-300">
            <strong>Tip:</strong> You can use the preset options for common
            schedules - really handy for beginners!
          </p>
        </div>
        ...
        <p className="mb-6 text-text/90">
          No JSON data is needed for this example. Make sure "Enabled" is
          checked and click "Create Trigger".
        </p>
        ...
        <p className="mb-4 text-text/90">
          Let's test our function! Click the "Run" button in the function
          dashboard.
        </p>
        <p className="mb-6 text-text/90">
          It's normal to get an error on the first run - wait a minute or two
          for dependency installation (timing depends on your system
          performance). Run it again after installation completes, and you
          should see your Discord message appear!
        </p>
        ...
        <div className="mt-12 p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-primary/30 rounded-xl">
          ...
          <p className="text-text/90 mb-4">
            Now that you've created your first function, let's explore how to
            pass data between triggers/HTTP requests and functions using JSON
            payloads.
          </p>
          <a
