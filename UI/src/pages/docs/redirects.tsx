		...
		<div className="min-h-screen bg-background text-text p-8">
			<div className="max-w-4xl mx-auto">
				...
				<p className="mt-3 text-lg text-text/90 mb-6">
					Functions can trigger HTTP redirects by setting special response fields.
					This is useful for workflows where you want to send the user to a different
					URL after an action, such as after login or form submission.
				</p>
				...
				<p className="mb-4 text-text/90">
					To perform a redirect, your function should return an object with the{" "}
					<code>_code</code> property set to <code>301</code> (permanent) or{" "}
					<code>302</code> (temporary), and the <code>_location</code> property set
					to the target URL as a string.
				</p>
				<div className="mb-6">
    ...
    return {
        ...
        "_shsf": "v2"
				...
				<ul className="list-disc list-inside mb-4 text-text/90">
					<li>
						<code>_code</code> must be <code>301</code> or <code>302</code> to trigger
						a redirect.
					</li>
					<li>
				...
				<ul className="list-disc list-inside mb-4 text-text/90">
					<li>
						Only <code>301</code> and <code>302</code> status codes are supported for
						redirects.
					</li>
					<li>
						If <code>_location</code> is missing or not a string, no redirect will
						occur.
					</li>
				...
				<div className="mt-12 p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-primary/30 rounded-xl">
					...
					<p className="text-text/90 mb-4">
						...
						functions, which is essential for working with file uploads and binary
						data.
					</p>
					<a
						href="/docs/raw-body"
