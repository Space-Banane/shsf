  ...
  return (
    <div className="min-h-screen bg-background text-text p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mt-3 text-lg text-text/90 mb-6">
          Functions can trigger HTTP redirects by setting special response
          fields. This is useful for workflows where you want to send the user
          to a different URL after an action, such as after login or form
          submission.
        </p>
        ...
        <p className="mb-4 text-text/90">
          ...
          <code>302</code> (temporary), and the <code>_location</code> property
          set to the target URL as a string.
        </p>
        <div className="mb-6">
    ...
    return {
        ...
        <ul className="list-disc list-inside mb-4 text-text/90">
          <li>
            <code>_code</code> must be <code>301</code> or <code>302</code> to
            trigger a redirect.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mb-4 text-text/90">
          <li>
            Only <code>301</code> and <code>302</code> status codes are
            supported for redirects.
          </li>
          <li>
            If <code>_location</code> is missing or not a string, no redirect
            will occur.
          </li>
          <li>
            Other response data will be ignored if a redirect is triggered.
          </li>
        </ul>
