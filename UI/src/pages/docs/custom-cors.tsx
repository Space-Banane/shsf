    ...
    <div className="min-h-screen bg-background text-text p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 p-4 bg-yellow-900/20 border-l-4 border-yellow-400 rounded">
          <b>Note:</b> CORS settings are <b>per-function</b>. You can allow or
          deny specific origins for each function separately. SHSF and its UI
        ...
        <ol className="list-decimal list-inside mb-4 text-text/90 space-y-2">
          <li>
            <b>When Creating a Function:</b> In the <b>Create Function</b>{" "}
            modal, find the <b>CORS Origins</b> section. Enter one or more
            allowed origins (e.g., <code>https://example.com</code>). You can
            add multiple origins, separated by commas, or use the UI controls to
            add/remove them.
          </li>
          <li>
            <b>When Editing a Function:</b> In the <b>Update Function</b> modal,
            scroll to the <b>CORS Origins</b> section. Here you can update, add,
            or remove allowed origins at any time.
          </li>
        </ol>
        ...
        <p className="mb-4 text-text/90">
          With this setting, only requests from <code>https://myapp.com</code>{" "}
          and <code>https://admin.myapp.com</code> will be allowed. All other
          origins will be blocked by the browser.
        </p>
        ...
        <ul className="list-disc list-inside mb-4 text-text/90">
          ...
          <li>
            You can update CORS origins at any time via the function settings in
            the UI.
          </li>
          <li>
        ...
        <div className="mb-6 p-4 bg-red-900/20 border-l-4 border-red-400 rounded">
          ...
          supported for security reasons. You must specify exact domain origins
