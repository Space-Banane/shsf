    ...
    <div className="min-h-screen bg-background text-text p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mt-3 text-lg text-text/90 mb-6">
          SHSF provides a simple Python interface for fast, persistent storage
          and retrieval of data using the <code>_db_com.py</code> script. This
          lets you create, update, and fetch data from your serverless functions
          with minimal code.
        </p>

        <div className="mb-6 p-4 bg-yellow-900/20 border-l-4 border-yellow-400 rounded">
          <b>Note:</b> You must install the <code>requests</code> package in
          your Python environment. Add it to your <code>requirements.txt</code>{" "}
          file.
        </div>
        ...
        <ul className="list-disc list-inside mb-4 text-text/90">
          ...
          <li>
            Always check for <code>None</code> or handle{" "}
            <code>DatabaseError</code> when retrieving data.
          </li>
          <li>
            Expiration is optional; if not set, data persists until deleted.
          </li>
        </ul>
        ...
        <div className="mt-12 p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-primary/30 rounded-xl">
          ...
          <p className="text-text/90 mb-4">
            Let's look at how we can handle multiple routes in a single
            function.
          </p>
          <a
            href="/docs/routing"
