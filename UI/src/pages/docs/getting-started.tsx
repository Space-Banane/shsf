	...
	return (
		<div className="min-h-screen bg-background text-text p-8">
			<div className="max-w-4xl mx-auto">
				...
				<p className="mb-4 text-text/90">
					Copy the example environment file and customize it for your setup. You must
					provide database credentials and URLs.
				</p>
				...
				<div className="mb-6 p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
					<p className="text-sm text-blue-300">
						<strong>Tip:</strong> See the example.env file for detailed configuration
				...
				<p className="mb-4 text-text/90">
					...
					environment. These variables control server ports, database connections,
					front-end URLs, and a few operational flags.
				</p>
...
CORS_URLS=https://space.reversed.dev  # comma-separated allowed origins`}
				...
				<div className="mb-6 space-y-3">
					...
					<div>
						...
						<p className="text-text/80 text-sm">
							Primary domain or hostname for the application (used for links, cookies,
							etc.).
						</p>
					</div>
					...
					<div>
						...
						<p className="text-text/80 text-sm">
							URL the frontend uses to send API requests (e.g., http://localhost:5000).
						</p>
					</div>
					...
					<div>
						...
						<p className="text-text/80 text-sm">
							Configures request rate limiting. Tune to your needs and infrastructure.
						</p>
					</div>
					...
					<div>
						...
						<p className="text-text/80 text-sm">
							Comma-separated origins allowed by CORS. Include UI_URL and any other
							trusted domains.
						</p>
					</div>
				</div>
				...
				<p className="mb-4 text-text/90">
					...
					<code>database</code> service in <code>docker-compose.yml</code> to run one
					locally.
				</p>
				...
				<div className="mb-6 p-4 bg-green-900/20 border border-green-500/30 rounded-lg">
					<p className="text-sm text-green-300">
						<strong>Success:</strong> This command will start all SHSF services in the
						background. Wait a few moments for everything to initialize.
					</p>
				</div>
				...
				<p className="mb-6 text-text/90">
					...
					registration by setting the appropriate flag in your <code>.env</code> file
					for security.
				</p>

				<h3 className="text-xl font-semibold text-primary mb-4">Function Limits</h3>
				<p className="mb-6 text-text/90">
					You can create as many functions as your system resources can handle. SHSF
					doesn't impose artificial limits - scale according to your needs and
					hardware capabilities.
				</p>

				<h3 className="text-xl font-semibold text-primary mb-4">Updating</h3>
				<p className="mb-6 text-text/90">
					To update SHSF, pull the latest changes from the repository, update your
					dependencies, and restart the Docker containers:
				</p>
				<pre className="bg-gray-900 p-4 rounded-lg overflow-x-auto text-sm mb-4">
					<code>
						{`git pull
...
docker compose up -d`}
				...
				<div className="mb-8 p-4 bg-yellow-900/20 border border-yellow-500/30 rounded-lg">
					<p className="text-sm text-yellow-300">
						<strong>Note:</strong> Always back up your database and configuration
						files before performing updates.
					</p>
				</div>
				...
				<div className="mt-12 p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-primary/30 rounded-xl">
					...
					<p className="text-text/90 mb-4">
						Now that SHSF is running, let's create your first function! What about a
						Discord Webhook that tells us Happy Monday every Monday at midnight?
					</p>
					<a
