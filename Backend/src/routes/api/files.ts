...
export = new fileRouter.Path("/")
	...
	.http("GET", "/api/function/{id}/files", (http) =>
		http
			.document({
				description: "List all files for a function",
				tags: ["Function Files"] as OpenAPITags[],
				operationId: "listFunctionFiles",
				responses: {
					200: {
						description: "List of function files",
						content: {
							"application/json": {
								schema: {
									type: "object",
	...
	.http("DELETE", "/api/function/{id}/file/{fileId}", (http) =>
		http
			.document({
				description: "Delete a file from a function by file ID",
				tags: ["Function Files"] as OpenAPITags[],
				operationId: "deleteFunctionFile",
				responses: {
					200: {
	...
	.http("PATCH", "/api/function/{id}/file/{fileId}/rename", (http) =>
		http
			.document({
				description: "Rename a function file by file ID",
				tags: ["Function Files"] as OpenAPITags[],
				operationId: "renameFunctionFile",
				requestBody: {
					content: {
						"application/json": {
							schema: {
								...
								properties: {
									newFilename: {
										type: "string",
										description: "New filename to assign",
									},
								},
							},
						},
	...
	.http("GET", "/api/function-fill-defaults", (http) =>
		http
			.document({
				description: "List all available default fill templates",
				tags: ["Function Files"] as OpenAPITags[],
				operationId: "listFillDefaults",
				responses: {
					200: {
						description: "List of available default templates",
						content: {
							"application/json": {
								schema: {
									type: "object",
