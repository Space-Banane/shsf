...
export = new fileRouter.Path("/")
	...
	.http("GET", "/api/function/{id}/cors-origins", (http) =>
		http
			.document({
				description: "Get CORS origins for a function",
				tags: ["Functions"] as OpenAPITags[],
				operationId: "getFunctionCorsOrigins",
				responses: {
					200: {
						description: "CORS origins fetched successfully",
						content: {
							"application/json": {
								schema: {
									type: "object",
	...
	.http("PATCH", "/api/function/{id}/cors-origins", (http) =>
		http
			.document({
				description: "Update CORS origins for a function",
				tags: ["Functions"] as OpenAPITags[],
				operationId: "updateFunctionCorsOrigins",
				requestBody: {
					content: {
						"application/json": {
							schema: {
								...
								properties: {
									cors_origins: {
										type: "string",
										description:
											"Comma-separated list of allowed origins (e.g. https://site.com,*)",
									},
								},
							},
						},
				...
				responses: {
					200: {
						description: "CORS origins updated successfully",
						content: {
							"application/json": {
								schema: {
									type: "object",
